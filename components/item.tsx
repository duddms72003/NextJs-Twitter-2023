        ...
        <div className="flex">
          ...
          <div className="w-full">
            ...
            <div className="ml-[10px] flex justify-between">
              ...
              <button className="p-3  rounded-full flex items-center hover:bg-gray-100 justify-center  text-gray-400 hover:text-gray-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                <span className="text-sm font-mono">{hearts}</span>
              </button>
              <button>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
