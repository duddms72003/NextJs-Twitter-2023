  ...
  "../../node_modules/.pnpm/semver@6.3.1/node_modules/semver/semver.js"(exports, module2) {
    ...
    SemVer.prototype.comparePre = function(other) {
      ...
      do {
        ...
        debug4("prerelease compare", i3, a, b2);
    ...
    Range.prototype.parseRange = function(range) {
      ...
      debug4("comparator trim", range, safeRe[t2.COMPARATORTRIM]);
    ...
    function replaceTilde(comp, options) {
      ...
      return comp.replace(r2, function(_, M, m2, p2, pr) {
        debug4("tilde", comp, _, M, m2, p2, pr);
        var ret;
        if (isX(M)) {
          ret = "";
        } else if (isX(m2)) {
    ...
    function replaceCaret(comp, options) {
      ...
      return comp.replace(r2, function(_, M, m2, p2, pr) {
        debug4("caret", comp, _, M, m2, p2, pr);
        var ret;
        if (isX(M)) {
          ret = "";
        } else if (isX(m2)) {
...
// ../../node_modules/.pnpm/ts-pattern@5.0.5/node_modules/ts-pattern/dist/index.js
